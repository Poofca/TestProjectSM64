...
const GeoLayout castle_courtyard_area_2_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 3688, -356, -3112, 2, -136, 1, castle_courtyard_dl_BetweenChipsPool_001_mesh_layer_1),
		...
		GEO_OPEN_NODE(),
			...
			GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -653, 1200, 3971, 0, 14, 0, castle_courtyard_dl_DiceObj_003_mesh_layer_1),
		...
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 5222, 0, 4008, castle_courtyard_dl_Pool_Table_Coll_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 5222, 0, 4008, castle_courtyard_dl_Pool_Table_Coll_001_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT_DECAL, 5222, -2649, 6889, castle_courtyard_dl_Pool_Table_CollArrows_002_mesh_layer_6),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 5785, 718, -777, 0, 0, -48, castle_courtyard_dl_PoolCue_001_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 4518, 718, -969, 0, -180, -48, castle_courtyard_dl_PoolCue_003_mesh_layer_1),
