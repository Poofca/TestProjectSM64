...
const GeoLayout castle_courtyard_area_2_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 4122, -356, -2712, 2, -143, 1, castle_courtyard_dl_BetweenChipsPool_001_mesh_layer_1),
		...
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 5321, -2649, 7289),
		...
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, -5035, 0, 0),
		GEO_OPEN_NODE(),
			GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 3879, -4, 4343, 5, 57, -24, castle_courtyard_dl_PokerChip_mesh_layer_1),
			GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 5039, -105, 3535, 7, 90, -24, castle_courtyard_dl_PokerChip_001_mesh_layer_1),
			GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 5429, -17, 1332, 22, -90, -90, castle_courtyard_dl_PokerChip_002_mesh_layer_1),
			GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 5429, 494, 1881, 22, -90, -90, castle_courtyard_dl_PokerChip_003_mesh_layer_1),
			GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 5429, 269, 882, -11, -70, 28, castle_courtyard_dl_PokerChip_004_mesh_layer_1),
			GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 5429, -352, 2326, -10, -70, 28, castle_courtyard_dl_PokerChip_005_mesh_layer_1),
			GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 5454, 311, -270, -12, -99, 28, castle_courtyard_dl_PokerChip_006_mesh_layer_1),
		...
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 5321, 0, 4408, castle_courtyard_dl_Pool_Table_Coll_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 5321, 0, 4408, castle_courtyard_dl_Pool_Table_Coll_001_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT_DECAL, 5321, -2649, 7289, castle_courtyard_dl_Pool_Table_CollArrows_002_mesh_layer_6),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 5888, 862, 121, 0, 0, -48, castle_courtyard_dl_PoolCue_001_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 4621, 862, -70, 0, -180, -48, castle_courtyard_dl_PoolCue_003_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -2630, 7486, -2205, 0, -180, 0, castle_courtyard_dl_SlideStartCollision_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
