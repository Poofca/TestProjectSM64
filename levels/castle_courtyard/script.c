...
const LevelScript level_castle_courtyard_entry[] = {
	...
	AREA(2, castle_courtyard_area_2),
		...
		OBJECT(MODEL_YELLOW_COIN, 5573, -718, -149, 0, 0, 0, 0x00000000, bhvYellowCoin),
		OBJECT(MODEL_YELLOW_COIN, 5986, -1395, 2799, 0, 0, 0, 0x00000000, bhvYellowCoin),
		OBJECT(MODEL_YELLOW_COIN, 5176, -1885, 4603, 0, 0, 0, 0x00000000, bhvYellowCoin),
		OBJECT(MODEL_YELLOW_COIN, 6211, -2361, 6381, 0, 0, 0, 0x00000000, bhvYellowCoin),
