...
const LevelScript level_castle_courtyard_entry[] = {
	...
	AREA(2, castle_courtyard_area_2),
		...
		OBJECT(MODEL_YELLOW_COIN, 398, 214, 1633, 0, 0, 0, 0x00000000, bhvYellowCoin),
		OBJECT(MODEL_YELLOW_COIN, 2984, -43, -4107, 0, 0, 0, 0x00000000, bhvYellowCoin),
		OBJECT(MODEL_YELLOW_COIN, 5241, -718, 27, 0, 0, 0, 0x00000000, bhvYellowCoin),
		OBJECT(MODEL_YELLOW_COIN, 5652, -1395, 2799, 0, 0, 0, 0x00000000, bhvYellowCoin),
		OBJECT(MODEL_YELLOW_COIN, 4842, -1885, 4603, 0, 0, 0, 0x00000000, bhvYellowCoin),
		OBJECT(MODEL_YELLOW_COIN, 5652, -2361, 6381, 0, 0, 0, 0x00000000, bhvYellowCoin),
		OBJECT(MODEL_NONE, -2630, 9683, -672, 0, -180, 0, 0x000B0000, bhvInstantActiveWarp),
		OBJECT(MODEL_NONE, -2630, 9583, -672, 0, -180, 0, 0x000A0000, bhvInstantActiveWarp),
	...
	AREA(1, castle_courtyard_area_1),
		...
		OBJECT(MODEL_YELLOW_COIN, -2358, 3441, 6362, 0, 0, 0, 0x00000000, bhvYellowCoin),
		OBJECT(MODEL_YELLOW_COIN, -6985, 3617, 6157, 0, 0, 0, 0x00000000, bhvYellowCoin),
