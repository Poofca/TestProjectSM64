...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		OBJECT(MODEL_NONE, 0, -255, 2564, 0, -180, 0, (2 << 24), bhvDoor),
		OBJECT(MODEL_BLACK_BOBOMB, 1278, -159, 1496, 0, -105, 0, (2 << 16), bhvBobombBuddy),
		OBJECT(MODEL_BLACK_BOBOMB, 345, -159, 1247, 0, 75, 0, (3 << 16), bhvBobombBuddy),
		...
		OBJECT(MODEL_BOBOMB_BUDDY, 475, -159, 1714, 0, 135, 0, (4 << 16), bhvBobombBuddy),
		...
		OBJECT(MODEL_FLYGUY, 686, -159, 908, 0, 15, 0, (1 << 16), bhvFlyGuyNPC),
		OBJECT(MODEL_FLYGUY, 1330, 924, 1389, 0, -112, 0, (39 << 16), bhvFlyGuyNPC),
		OBJECT(MODEL_GOOMBA_HAT, 0, -226, 407, 0, 0, 0, (43 << 16), bhvGoombaHatNPC),
		OBJECT(MODEL_GOOMBA_HAT, 0, 857, -251, 0, 0, 0, (46 << 16), bhvGoombaHatNPC),
		...
		OBJECT(MODEL_WOODEN_SIGNPOST, 0, 828, 2493, 0, -180, 0, (48 << 16), bhvMessagePanel),
